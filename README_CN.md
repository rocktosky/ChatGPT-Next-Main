...
2. 点击右侧按钮开始部署：
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fpoboll%2FChatGPT-Next-Main&env=OPENAI_API_KEY&env=CODE&project-name=chatgpt-next-main&repository-name=ChatGPT-Next-Main)，直接使用 Github 账号登录即可，记得在环境变量页填入 API Key 和 搜索插件入口。(可选)[页面访问密码](#配置页面访问密码) CODE；
3. 部署完毕后，即可开始使用；
