...
2. Click
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fpoboll%2FChatGPT-Next-Main&env=OPENAI_API_KEY&env=CODE&project-name=chatgpt-next-main&repository-name=ChatGPT-Next-Main), `CODE` is password;
3. Enjoy :)
